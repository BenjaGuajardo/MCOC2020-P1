...
plt.subplot(3,1,1)
plt.title('Posición')
plt.plot(tiempo/3600,x/1000,'b')
plt.plot(t/3600,x_o/1000,'orange')
plt.ylabel('x(t) [km]')

plt.subplot(3,1,2)
plt.plot(tiempo/3600,y/1000,'b')
plt.plot(t/3600,y_o/1000,'orange')
plt.ylabel('y(t) [km]')

plt.subplot(3,1,3)
plt.plot(tiempo/3600,z/1000,'b')
plt.plot(t/3600,z_o/1000,'orange')
plt.ylabel('z(t) [km]')
plt.xlabel('tiempo [h]')
plt.tight_layout()

plt.savefig('posicion_predicha.png')
